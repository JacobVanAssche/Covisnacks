...
while True:
	...
	sendEventMessageObj = json.dumps({
	...
	#print sendEventMessageObj
	producer_topic = "4c7489ed-92c0-4e05-a23d-12cdf514fc6a"
	mqttc.publish(producer_topic, str(sendEventMessageObj), Qos, retain=False)
